...
def generate_index():
    ...
    readme_content = [
        ...
        "",
        "**Note**: For the main workspace overview and quick start guide, see [`README.md`](README.md).",
        "",
        "## 📁 Directories",
        ""
    ]
    ...
    with open("WORKSPACE_INDEX.md", "w") as f:
        f.write("\\n".join(readme_content))

    print("✅ WORKSPACE_INDEX.md updated with latest index.")
